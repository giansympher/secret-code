(window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [1],
  {
    ...
    elyg: function (t, e, r) {
      ...
      function E(t) {
        return (
          (t = t.slice(w.length)).startsWith('/') || (t = '/'.concat(t)), t
        );
      }
      function R(t) {
      ...
      function A(t, e) {
        return fetch(t, { credentials: 'same-origin' }).then(function (r) {
          if (!r.ok) {
            if (e > 1 && r.status >= 500) return A(t, e - 1);
            if (404 === r.status)
      ...
      function D(t, e) {
        return A(t, e ? 3 : 1).catch(function (t) {
                      ...
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 50:
                              if (
                                ((b = this._resolveHref(b, A)).pathname !== C &&
                                  ((C = b.pathname),
